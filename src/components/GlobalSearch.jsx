    ...
    <div className="relative w-full" ref={searchRef}>
      ...
      <div className="relative">
        <input
          ...
          className="h-10 w-full rounded-lg border border-slate-200 bg-white pl-10 pr-4 text-sm font-medium text-slate-900 outline-none transition placeholder:text-slate-400 focus:border-slate-300 focus:ring-2 focus:ring-slate-100"
        />
        <svg
      ...
      {showResults && searchTerm && (
        <div className="absolute z-50 mt-2 max-h-96 w-full overflow-y-auto rounded-lg border border-slate-200 bg-white shadow-lg">
          {totalResults === 0 && !loading ? (
            ...
            <div className="divide-y divide-gray-100">
              ...
              {results.patients.length > 0 && (
                <div className="p-2">
                  <p className="px-3 py-2 text-xs font-medium text-gray-500 uppercase tracking-wider">Patients</p>
                  {results.patients.map((patient) => (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs font-medium text-gray-500">{patient.phone} • {patient.insurance_type || 'No insurance'}</p>
                      </div>
                    </Link>
                  ))}
                </div>
              ...
              {results.drugs.length > 0 && (
                <div className="p-2">
                  <p className="px-3 py-2 text-xs font-medium text-gray-500 uppercase tracking-wider">Drugs</p>
                  {results.drugs.map((drug) => (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs font-medium text-gray-500">{drug.category} • Stock: {drug.stock} • GH₵{drug.price}</p>
                      </div>
                    </Link>
                  ))}
                </div>
              ...
              {results.prescriptions.length > 0 && (
                <div className="p-2">
                  <p className="px-3 py-2 text-xs font-medium text-gray-500 uppercase tracking-wider">Prescriptions</p>
              ...
              {results.appointments.length > 0 && (
                <div className="p-2">
                  <p className="px-3 py-2 text-xs font-medium text-gray-500 uppercase tracking-wider">Appointments</p>
